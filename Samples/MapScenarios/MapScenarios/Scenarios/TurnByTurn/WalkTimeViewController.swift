...
class WalkTimeViewController: TurnByTurnViewController {
    ...
    func updateWalkTimeView() {
        ...
        walkTimeView.isHidden = false
        walkTimeView.restTimeLabel.text = format(duration: duration)
        walkTimeView.arriveTimeLabel.text = "Arrive Time \(format(date: arriveTime))"
    }
...
extension WalkTimeViewController {
